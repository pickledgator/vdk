...
import (
	...
	"github.com/pickledgator/vdk/codec"
	"github.com/pickledgator/vdk/codec/aacparser"
	"github.com/pickledgator/vdk/codec/h264parser"
	"github.com/pickledgator/vdk/codec/h265parser"
	"github.com/pickledgator/vdk/format/rtsp/sdp"
)
		...
		for _, nal := range nalRaw {
			if client.videoCodec == av.H265 {
				...
				case naluType == 8:
					client.CodecUpdatePPS(nal)
				case naluType == 24:
					client.Println("24 Type need add next version report https://github.com/pickledgator/vdk")
				case naluType == 28:
